...
const courses: { name: string; group: string; age: string; desc: string; duration: string; location: string; status: Status; price?: { standard: string; member: string; units: string } | "tbd" }[] = [
  ...
  { name: "Schwimmabzeichen Seepferdchen", group: "Kinder", age: "5–8", desc: "Gezielte Vorbereitung auf das Seepferdchen-Abzeichen.", duration: "10 Wochen", location: "Hallenbad Hennef", status: "Warteliste", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
