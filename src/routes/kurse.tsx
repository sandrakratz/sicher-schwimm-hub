...
const courses: { name: string; group: string; age: string; desc: string; requirements: string; duration: string; location: string; status: Status; price?: { standard: string; member: string; units: string } | "tbd" }[] = [
  { name: "Wassergewöhnung", group: "Kinder", age: "3–5 Jahre", desc: "Spielerische erste Erfahrungen im Wasser ohne Leistungsdruck.", requirements: "Keine Voraussetzungen.", duration: "10 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Warteliste", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
  { name: "Eltern & Kind", group: "Familien", age: "1–3 Jahre", desc: "Gemeinsame Wasserzeit für Eltern mit Kleinkindern.", requirements: "Keine Voraussetzungen.", duration: "8 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Warteliste", price: "tbd" },
  { name: "Anfänger Schwimmen", group: "Kinder", age: "ab 5", desc: "Erste Schwimmtechniken und Sicherheit im Wasser.", requirements: "Keine Angst vor Wasser, ggf. altersgerechte Motorik (Hampelmann, Laufrad-/Fahrradfahren).", duration: "12 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Warteliste", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
  { name: "Schwimmabzeichen Seepferdchen", group: "Kinder", age: "5–8", desc: "Gezielte Vorbereitung auf das Seepferdchen-Abzeichen.", requirements: "Kopf unter Wasser nehmen, Springen ins Wasser, Motorik Hampelmann.", duration: "10 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Offen", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
  { name: "Schwimmabzeichen Bronze", group: "Kinder/Jugend", age: "ab 7", desc: "Sicheres Schwimmen über längere Strecken.", requirements: "Bedingungen des Seepferdchen-Abzeichens müssen erfüllt sein.", duration: "10 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Offen", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
  { name: "Schwimmabzeichen Silber", group: "Kinder/Jugend", age: "ab 9", desc: "Erweiterte Technik und Ausdauer.", requirements: "Bedingungen des Bronze-Abzeichens müssen erfüllt sein.", duration: "10 Wochen", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Offen", price: { standard: STANDARD_PRICE, member: MEMBER_PRICE, units: STANDARD_UNITS } },
  { name: "Ferien-Intensivkurse", group: "Kinder", age: "5–10", desc: "Schnell ins Schwimmen kommen in den Ferien.", requirements: "Je nach Kursniveau – bitte bei Anfrage angeben.", duration: "5 Tage", location: "Schwimmbad im Rhein-Sieg-Kreis (genauer Kursort wird rechtzeitig bekannt gegeben)", status: "Warteliste", price: "tbd" },
];
