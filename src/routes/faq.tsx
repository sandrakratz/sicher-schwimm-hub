...
const faqs = [
  ...
  { q: "Was passiert, wenn mein Kind krank ist?", a: "Kranke Kinder können nicht am Kurs teilnehmen, bitte melden Sie das Kind von der Stunde ab." },
  { q: "Dürfen Eltern beim Unterricht zusehen?", a: "Entscheiden die Trainer*innen je nach Gruppe und Gegebenheiten. In der Regel sind Eltern nicht anwesend." },
